...
Adaptation note: CreatorOS adds Google Gemini as a provider for text-generation and text-scoring capabilities. The Provider Client interface and Cost Ledger patterns are unchanged.
───────────────────────────────────────────────────────────────────── -->
