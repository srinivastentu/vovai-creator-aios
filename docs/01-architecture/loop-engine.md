...
Adaptation note: CreatorOS adds 'cross-critique' as a 5th loop pattern. See docs/01-architecture/loop-patterns.md and docs/01-architecture/cross-critique-pattern.md for the addition.
───────────────────────────────────────────────────────────────────── -->
...
AWAITING_REVIEW
  ...
  ├─ [inline_edit]   → APPROVED (edited version locked)
